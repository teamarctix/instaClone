      ...
      <section className="flex flex-col gap-6 w-full my-8">
        ...
        <div className="flex items-center justify-between bg-gray-100 rounded-xl p-4">
          ...
          <Button
            ...
            className="bg-[#0095f6] h-8 hover:bg-[#2985c3]">
            Changed photo
          </Button>
        </div>
        <div>
        ...
        <div className="flex justify-end">
          {loading ? (
            <Button className="w-fit bg-[#0095f6] h-8 hover:bg-[#2985c3]">
              <Loader2 className="mr-2 h-4 animate-spin" />
              Please Wait
            </Button>
          ) : (
            <Button onClick={editProfileHandler} className="w-fit bg-[#0095f6] h-8 hover:bg-[#2985c3]">
              Submit
            </Button>
          )}
        </div>
